...
此时，问题可能就出在缓存上（cash）[参看My .gitignore file is ignored by git and it does not work](https://bytefreaks.net/programming-2/my-gitignore-file-is-ignored-by-git-and-it-does-not-work)。
