...
```{r, echo=FALSE}
knitr::include_graphics("picture/zetero-export-betterbib.png",error = F)
```


- 写作文件.Rmd的yaml区域指明对.bib的关联关系，并设定文献列出样式（csl style）及关联关系
...
- 直接行内引用（注意key和后面文本的空格）：`@refkey says that ...`
