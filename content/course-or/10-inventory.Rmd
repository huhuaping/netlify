...
knitr::include_url("/course-or/03-slide-class/10-inventory.html")
```

以下种类型课件都可以使用，两者可以互补，但强烈建议使用第一种类型`Xaringan slide`课件[^a]：

**1.现代型课件（Xaringan slide）**（操作提示[^b]）：`r fontawesome::fa('slideshare', fill= "blue", height='17px' )`[第10章 库存模型.html](/course-or/03-slide-class/10-inventory.html) 。


**2.传统型课件（pdf）**：`r fontawesome::fa('file-pdf', fill= "blue", height='17px' )`[第10章 库存模型.pdf](/course-or/material/10-inventory.pdf) 。（更新日期：2022.4.29）
