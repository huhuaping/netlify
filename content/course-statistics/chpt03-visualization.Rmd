...
summary: ''
authors: [胡华平]
lastmod: '2021-02-28T18:03:18+08:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
**2.传统型课件（pdf）**：`r fontawesome::fa('file-pdf', fill= "blue", height=17 )`[第03章-数据的图表展示.pdf](/course-statistics/material/03-visualization-2021.5.8.pdf) 。（2021.05.08更新）。
