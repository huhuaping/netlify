...
summary: ''
authors: [胡华平]
lastmod: '2021-02-05T18:01:18+08:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
**1.现代型课件（Xaringan slide）**（操作提示[^b]）：`r fontawesome::fa('slideshare', fill= "blue", height=17 )`[第01章-绪论.html](/course-statistics/03-slide-class/02-data-sourcing.html) 。


**2.传统型课件（pdf）**：`r fontawesome::fa('file-pdf', fill= "blue", height=17 )`[第01章-绪论.pdf](#) 。
