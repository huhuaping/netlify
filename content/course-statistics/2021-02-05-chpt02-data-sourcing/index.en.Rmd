...
**1.现代型课件（Xaringan slide）**（操作提示[^b]）：`r fontawesome::fa('slideshare', fill= "blue", height=17 )`[第02章-数据收集、整理和清洗.html](/course-statistics/03-slide-class/02-data-sourcing.html) 。


**2.传统型课件（pdf）**：`r fontawesome::fa('file-pdf', fill= "blue", height=17 )`[第02章-数据收集、整理和清洗.pdf](/course-statistics/material/02-data-sourcing-2019.9.29.pdf) 。
