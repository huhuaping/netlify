...
summary: ''
authors: [胡华平]
lastmod: '2021-05-25T18:04:18+08:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
**PART A 全章课件（第07章 指数）**：（文档较大，加载速度可能比较慢）

- **1.现代型课件（Xaringan slide）**（操作提示[^b]）：`r fontawesome::fa('slideshare', fill= "blue", height='17px' )`[**html课件**](/course-statistics/03-slide-class/07-complex-index.html) 

- **2.传统型课件（pdf）**：`r fontawesome::fa('file-pdf', fill= "blue", height='17px' )`[**pdf课件**](/course-statistics/material/07-complex-index.pdf) （更新日期：2021.5.26）
